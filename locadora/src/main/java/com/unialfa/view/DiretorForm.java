...
public class DiretorForm extends JFrame{
    ...
    private Diretor construirDiretor(){
        return campoId.getText().isEmpty()
                ? new Diretor(
                campoNomeDiretor.getText(),
                campoNacionalidadeDiretor.getText(),
                //converterData(campoDataNascimentoDiretor.getText()),
                parseInt(campoPremiacaoDiretor.getText()),
    ...
    private Date converterData(String data) throws ParseException{
        ...
        return Date.valueOf(formatoSaida.format(formatoEntrada.parse(data)));
    }
}
